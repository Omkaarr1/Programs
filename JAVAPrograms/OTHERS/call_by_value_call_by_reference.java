...
public class call_by_value_call_by_reference 
{
    ...
    public static void main(String[] args) 
    {
        ...
        System.out.println("After call Value of A and B (Call by Value) [After Calling] --> "+a+" "+b);
        refrence(x);    // Actual Parameter
        System.out.println("After call Value of A and B (Call by Refrence) [After Calling] --> "+a+" "+b);
    ...
    static void value(int a,int b) // Formal Parameter
    {
        ...
        System.out.println("Value of A and B (Call by Value) [Before Calling] --> "+a+" "+b);
    }
    ...
    { 
        ...
        x.a=x.b;
        x.b=temp;
        System.out.println("Value of A and B (Call by Refrence) [Before Calling] --> "+a+" "+b);
    }
}