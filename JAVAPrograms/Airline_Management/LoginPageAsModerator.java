...
public class LoginPageAsModerator  implements ActionListener 
{
    ...
    LoginPageAsModerator()
    {
    }

    LoginPageAsModerator(HashMap<String,String> Logininfo)
    {
